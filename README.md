...
* **LCF: A Local Context Focus Mechanism for Aspect-Based Sentiment Classification**. *Biqing Zeng, Heng Yang 2, Ruyang Xu, Wu Zhou, Xuli Han* (Applied Sciences 2019) [\[paper\]](https://www.mdpi.com/2076-3417/9/16/3389/pdf)[\[code\]](https://github.com/yangheng95/LCF-ABSA) ⭐ 1,104 | 🐛 70 | 🌐 Jupyter Notebook | 📅 2026-09-06 - ***LCF-BERT***
...
* **Exploiting BERT for End-to-End Aspect-based Sentiment Analysis**. *Xin Li, Lidong Bing, Wenxuan Zhang, Wai Lam*. (EMNLP 2019) [\[paper\]](https://www.aclweb.org/anthology/D19-5505/)[\[code\]](https://github.com/lixin4ever/BERT-E2E-ABSA) ⭐ 402 | 🐛 27 | 🌐 Python | 📅 2023-07-09 - ***BERT-E2E-ABSA***
